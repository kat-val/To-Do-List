...
export const TaskItem = ({text,todoTask,todosTask,setTodosTask}) => {
   ...
   return (
      <>
         <div className={`flex items-center ${todoTask.checked ? "gap-4" : ""}`}>
            ...
            <div className={`flex flex-col items-center ${todoTask.checked ? "justify-center text-neutral-500" : "h-full relative text-neutral-400"}`}>
               {todoTask.checked ?
                  <>
               ...
               :
                  <>
                     <i className="bi bi-pencil-square hover:text-violet-400 transition-colors duration-200 ease-out text-lg absolute right-12"></i>
                     <i className="bi bi-trash3 text-lg hover:text-red-400 transition-colors duration-200 ease-out absolute" onClick={deleteTask}></i> 
                  </>
               }
